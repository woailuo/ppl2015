...
Typing rules showed in Figure x are not immediately suitable for type inference. The reason is the subtyping rule which can be applied to every terms\cite{plain:book1}
