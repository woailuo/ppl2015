...
This section describe some theorems and lemmas for type safe.
...
If the partial correctness is guaranteed $\vdash \langle H,R,s \rangle$ and $\vdash \langle H,R,s,n \rangle$, then $\vdash \langle H',R',s',n' \rangle \nrightarrow Error$
\end{lemma}
