...
\end{minipage}
\caption{Typing rules\protect\footnotemark.}
\label{fig:typingrules}
\end{figure}

\footnotetext{Till now, we do not know the answer if the type system
  ...
  typed, and when any two types $P_ 1$ and $P_2$ are given, we need this
  choice type in order to obtain the lower bound of them.}
