...
The functions $h$ and $h'$ shown in Figure~\ref{ex:np} describe memory-leak freedom and memory leaks in nonterminating programs. Function $h$ requires two memory cells at most, whereas function $h'$ requires unbounded number of memory cells to be executed.
\begin{figure}[h]
