...
to \(h\) and \(h'\) above, our types include information only
...
%% \end{lemma}
\begin{lemma}
If $\vdash (D, s)$ then $\langle \emptyset, \emptyset, s \rangle \nrightarrow^{*}Error$(illegal accesses)
\end{lemma}
