...
system in Section~\ref{sec:typesystem}\footnote{The procedure
  described here is not complete.  We could reject a program that is
  well-typed in the type system.}.  Since the procedure is essentially
the same as one in Kobayashi et
