...
The procedure described in this section is not complete.  We could
reject a program that is well-typed in the type system.

The reconstruction procedure is a constraint-based one.  Given a
program, the reconstruction procedure generates constraints for the
program to be well-typed following the rules in
