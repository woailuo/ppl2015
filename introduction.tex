...
In real-world programs, in addition to the OS and Web servers
mentioned above, there are many programs which should be total
memory-leak freedom, such as traffic system, airplanes appliances,
electric system, medical instruments and so on, because without this
property, these programs may eventually crash and cause serious
problems due to lack of memory cells.
